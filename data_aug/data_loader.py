...
class CustomDataLoader():
    ...
    def get_loader(self, dataset_name, batch_size, workers, resize=False):
        ...
        if dataset_name == 'imagenet':
            ...
            if resize==True:
                ...
                train_transform, test_transform = transform(64, mean, std)
            # data prepare
            root = '~/workspace/BeCLR-master/data/tiny-imagenet-200'
            traindir = os.path.join(root, 'train')
            valdir = os.path.join(root, 'val')
